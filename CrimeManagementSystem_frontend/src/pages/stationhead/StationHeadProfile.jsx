...
export default function StationHeadProfile() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      if (msg.toLowerCase().includes('incorrect') ||
        ...
        setPasswordErrors({ currentPassword: 'Invalid password. Current password does not match.' })
      } else {
  ...
  return (
    <div style={{ backgroundColor: '#f0f2f5', minHeight: '100vh' }}>
      <nav className="navbar px-4 py-3" style={{ backgroundColor: '#1a1a2e' }}>
        <span className="navbar-brand fw-bold text-white">🚔 CMS — Station Head Profile</span>
