...
namespace CrimeManagementSystem.Tests
{
    ...
    public class OfficerServiceTests
    {
        ...
        [Test]
        public void RemoveOfficerAsync_OfficerNotFound_ThrowsException()
        {
            // Act & Assert
        ...
        // ── TEST 9: Get Officer Incidents Returns Empty List ──
        [Test]
        ...
        // ── TEST 10: Remove Already Deactivated Officer ───────
        [Test]
        public async Task RemoveOfficerAsync_AlreadyDeactivatedOfficer_StillSucceeds()
        {
            ...
            await _officerService.RemoveOfficerAsync(officer.OfficerId);
